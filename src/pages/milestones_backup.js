...
const MilestonesPage = () => (
  <Layout>
    ...
    <p className="text-3xl">Milestones in my life</p>
    <p>From a bird's eyes view, here are the most important events of my life so far.</p>
    <MyToggle title="I was born in 1981, in Budapest."/>

    <MyToggle
      title="Wrote my first line of code (at the age of 12)" content="in Turbo Pascal programming language"/>
