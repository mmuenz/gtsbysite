...
const HumanoidPage = () => (
  <Layout>
    <SEO
      ...
      description="The illusion of making friends (Márton Münz's website)"
    />
    ...
    <p>
      ...
      this mishap was recorded in 2006 and until his discontinuation in 2018,
      his abilities improved significantly. Today, of course, we see much more
    ...
    <p>
      Compassion from some people and irony from others. Nevertheless, even
    ...
    <p>
      ...
      and mythologies. It's in the stories we tell ourselves every day, from
    ...
    <p>
      Weirdly enough, research shows that humans can anthropomorphize anything:
    ...
    <p>
      Some of us even talk to their plants, and go as far as apologizing when
    ...
    <p>
      ...
      take so much pride, can be triggered by such a simple trick as equipping a
      robot with legs, arms, and a cute-looking head.{" "}
    </p>
    <p>
    ...
    <p>
      ...
      instincts. Understanding the factors that most strongly influence how
      machines and humans respond to each other is an active area of research in
      social robotics, a field focused on designing robots that can interact
      with humans in a socially engaging and efficient way.
    </p>
    <p>
      Although the appearance of the robot seems to be a key factor (especially
      its facial features), machines don't need to be fully human-like. As
      discussed above, we have a weird ability to anthropomorphize almost
      anything, even things that don't remotely resemble a human being.
    </p>
    <p>
    ...
    <p>
      ...
      Audrey Hepburn, and its inventor David Hanson's wife, Amanda Hanson.
      ...
      chance of winning the first price.
    </p>
    <p>
    ...
    <p>
      ...
      it will soon be hard for your brain to tell apart illusion and reality.
    </p>
    <p className="text-2xl">Perfect humanoids are imperfect </p>
    <p>
      {" "}
      Another thing came to my mind while watching the YouTube video showing
      ASIMO's staircase accident:
    </p>
    ...
    <p>
      ...
      be more successful in getting on well with human beings. Just like we
      often prefer hanging out with people who do not try to hide their faults.
    </p>
    <p>
      {" "}
      Unsurprisingly, research in human-AI interaction has found that AI systems
      which recognize and admit their own mistakes, and apologize, are perceived
      as more intelligent and likeable by humans. Attributing the blame to
      themselves, and apologizing was proven to be a very effective way to
      regain and maintain the trust of humans. It was found to be especially
    ...
    <p>
      ...
      objective is to mimic the imperfections of human decision-making in chess.
    </p>
    <p>
      {" "}
    ...
    <p>
      ...
      to building strong relationships among people. ASIMO appearing vulnerable
      in his staircase accident suddenly makes him more relatable in the eye of
    ...
    <p>
      {" "}
      Its engineers could certainly perfect the technology and eventually
      develop a robot that never in a million times fails to reach the top of
      the staircase, but that wouldn't make the robot more humanoid. After all,
      we humans sometimes fall down the stairs.{" "}
    </p>
